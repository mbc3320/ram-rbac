...
@Slf4j
@Service
public class RbacRoleServiceImpl extends CRUDServiceImpl<RbacRoleDTO, RbacRole, RbacRoleMapper> implements RbacRoleService {
    ...
    public AntTreeNodeVO findRolePermissionTree(RbacRolePermissionQuery query) {
        ...
        List<RbacRolePermissionCheckedDTO> list = baseMapper
