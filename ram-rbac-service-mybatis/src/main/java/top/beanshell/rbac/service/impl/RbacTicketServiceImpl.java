...
@Slf4j
@Service
public class RbacTicketServiceImpl extends CRUDServiceImpl<RbacTicketDTO, RbacTicket, RbacTicketMapper> implements RbacTicketService {
    ...
    private boolean refreshTicket(String ticket) {
        ...
        if (null != ticketInfo) {
            ...
            ticketUpdateThreads.execute(() -> {
                ...
                wrapper.eq(RbacTicket::getTicket, ticket);
                update(ti, wrapper);
            });
            return true;
        } else {
